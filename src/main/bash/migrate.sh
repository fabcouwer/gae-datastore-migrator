...
GERONIMO=$M2/org/apache/geronimo/specs/geronimo-jpa_2.0_spec/1.0/geronimo-jpa_2.0_spec-1.0.jar
...
java -cp $GWT:$JDO:$GERONIMO:$REMOTE_API:$GAE:$CLASSES:$SGM_CLASSES net.styleguise.tools.DatastoreMigrator
